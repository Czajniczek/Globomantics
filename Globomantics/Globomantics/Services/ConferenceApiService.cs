...
namespace Globomantics.Services
{
    public class ConferenceApiService : IConferenceService
    {
        ...
        public async Task<IEnumerable<ConferenceModel>> GetAll()
        {
            ...
            if (response.IsSuccessStatusCode) result = await response.Content.ReadAsAsync<List<ConferenceModel>>();
        ...
        public async Task<ConferenceModel> GetById(int id)
        {
            ...
            if (response.IsSuccessStatusCode) result = await response.Content.ReadAsAsync<ConferenceModel>();
        ...
        public async Task<StatisticsModel> GetStatistics()
        {
            ...
            if (response.IsSuccessStatusCode) result = await response.Content.ReadAsAsync<StatisticsModel>();
